...
- [x] 5.3 `permission_classes` customizado verificando pertencimento ao grupo, substituindo o `IsAuthenticated` puro nas views de decks/cards/categories/reviews — mecanismo pensado pra aceitar um grupo `ai_agent` na Sprint 10 sem mudar de estrutura (`apps/decks/permissions.py`, `HasAuthorizedGroup`)
