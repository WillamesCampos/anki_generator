...
urlpatterns = [
    ...
    path(
        "decks/<str:deck_id>/statistics/",
        views.DeckStatisticsView.as_view(),
    ...
    path("cards/count/", views.CardCountView.as_view(), name="card-count"),
    path("cards/<str:card_id>/", views.CardDetailView.as_view(), name="card-detail"),
    path(
        "cards/<str:card_id>/review/",
        views.CardReviewView.as_view(),
        name="card-review",
    ),
    path("reviews/", views.CardReviewListView.as_view(), name="review-list"),
]
