...
- **Decisão histórica**: aumentar o throttle foi rejeitado nesta sprint; a decisão foi posteriormente substituída por 10 req/s na Sprint 7 após nova evidência de uso legítimo do frontend.
